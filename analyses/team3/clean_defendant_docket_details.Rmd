...
ddt <- ddt %>%
  mutate(current_processing_status_status_change_datetime = if_else(current_processing_status_status_change_datetime <= earliest_dob, NA_Date_, current_processing_status_status_change_datetime))
...
```{r check_continuous, results = "asis"}
